...
import { profileIcon, historyIcon, familyIcon,
    documentsIcon,
    settingsIcon,
    favoriteIcon } from '../Icons/Profile';
...
const OpenURLButton = ({url, children}) => {
    ...
    return <TouchableWithoutFeedback onPress={handlePress} ><Text style={{fontSize: 10, color: '#3989FA', marginBottom: 8}}>{children}</Text></TouchableWithoutFeedback>;
};
    ...
    return (
        <SafeAreaView style={profile.container}>
            <View style={profile.top}>
                <TouchableWithoutFeedback style={profile.profilePhoto}>
                    <View style={profile.editLink}>
                        ...
                        <Text style={profile.phone}>
                            +7 999 888 77 66
                        </Text>
                        <Text style={profile.link}>
                            Редактировать
                        </Text>
                    </View>
                </TouchableWithoutFeedback>
            ...
            <View style={profile.footer}>
                <OpenURLButton url="https://ya.ru/">Политика конфиденциальности</OpenURLButton>
                <OpenURLButton url="https://ya.ru/">Пользовательское соглашение</OpenURLButton>
